...
- refactor(Scripts) [needs-design]: Finish the bounded Swift tooling migration.
  ...
  uses a validated, rollback-safe file transaction. What remains is the two
  installer ports plus extraction of the last substantive Python embedded in
  retained shell; close this item when those public shims have switched and
  parity is proven. (human 2026-07-28; migration in progress 2026-08-10)
