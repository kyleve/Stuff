...
- refactor(Scripts) [needs-design]: Finish the bounded Swift tooling migration.
  ...
  directly tested orchestration and separate command semantics. What remains is
  the transactional `./icons` and installer ports plus extraction of the last
  substantive Python embedded in retained shell; close this item when those
  public shims have switched and parity is proven. (human 2026-07-28; migration
