...
- refactor(Scripts) [needs-design]: Finish the bounded Swift tooling migration.
  ...
  typed `devicectl` selection. What remains is the Ledger installer plus
  extraction of the last substantive Python embedded in retained shell; close
  this item when those public shims have switched and parity is proven. (human
