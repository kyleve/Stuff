...
nonisolated struct TransitRealtime_TripUpdate: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var tripProperties: TransitRealtime_TripUpdate.TripProperties {
    get {_tripProperties ?? TransitRealtime_TripUpdate.TripProperties()}
    set {_tripProperties = newValue}
  }
  /// Returns true if `tripProperties` has been explicitly set.
  var hasTripProperties: Bool {self._tripProperties != nil}
  /// Clears the value of `tripProperties`. Subsequent reads from it will return its default value.
  mutating func clearTripProperties() {self._tripProperties = nil}
  ...
  fileprivate var _timestamp: UInt64? = nil
  fileprivate var _delay: Int32? = nil
  fileprivate var _tripProperties: TransitRealtime_TripUpdate.TripProperties? = nil
}
...
nonisolated extension TransitRealtime_FeedEntity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate final class _StorageClass: @unchecked Sendable {
    var _id: String? = nil
    ...
    var _alert: TransitRealtime_Alert? = nil
      ...
      // hence, sharing this immutable default is safe.
...
nonisolated extension TransitRealtime_TripUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public var isInitialized: Bool {
    ...
    if let v = self._tripProperties, !v.isInitialized {return false}
    return true
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeSingularMessageField(value: &self._tripProperties) }()
      case 1000..<2000, 9000..<10000:
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._tripProperties {
  ...
  static func ==(lhs: TransitRealtime_TripUpdate, rhs: TransitRealtime_TripUpdate) -> Bool {
    ...
    if lhs._tripProperties != rhs._tripProperties {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    if lhs._protobuf_extensionFieldValues != rhs._protobuf_extensionFieldValues {return false}
    return true
  }
...
nonisolated extension TransitRealtime_TripUpdate.TripProperties: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}trip_id\0\u{3}start_date\0\u{3}start_time\0")
...
nonisolated extension TransitRealtime_TripDescriptor.ScheduleRelationship: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SCHEDULED\0\u{1}ADDED\0\u{1}UNSCHEDULED\0\u{1}CANCELED\0\u{2}\u{2}REPLACEMENT\0\u{1}DUPLICATED\0")
}
