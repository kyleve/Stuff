...
let project = Project(
    ...
    targets: [
        ...
        unitTests(
            name: "FlaggerTests",
            bundleIdSuffix: "flagger",
            productDependency: "Flagger",
            sources: ["Shared/Flagger/Tests/**"],
        ),
        unitTests(
            name: "FlaggerUITests",
            bundleIdSuffix: "flaggerui",
            productDependency: "FlaggerUI",
            sources: ["Shared/FlaggerUI/Tests/**"],
            extraPackageProducts: ["Flagger"],
        ),
        unitTests(
        ...
        unitTests(
            name: "FlaggerUISnapshotTests",
            bundleIdSuffix: "flaggerui.snapshot",
            productDependency: "FlaggerUI",
            sources: ["Shared/FlaggerUI/SnapshotTests/**"],
            extraPackageProducts: ["SnapshotKitTesting"],
            environmentVariables: snapshotEnvironment,
        ),
        .target(
    ...
    schemes: [
        ...
        testScheme(name: "FlaggerTests"),
        testScheme(name: "FlaggerUITests"),
