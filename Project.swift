...
let project = Project(
    ...
    targets: [
        ...
        unitTests(
            name: "PortholeKitUITests",
            bundleIdSuffix: "porthole.kit.ui",
            productDependency: "PortholeKitUI",
            sources: ["Shared/Porthole/PortholeKitUI/Tests/**"],
            extraPackageProducts: ["PortholeKit", "PortholeCore"],
        ),
        unitTests(
        ...
        unitTests(
            name: "PortholeLifecycleTests",
            bundleIdSuffix: "porthole.lifecycle",
            productDependency: "PortholeLifecycle",
            sources: ["Shared/Porthole/PortholeLifecycle/Tests/**"],
            extraPackageProducts: ["PortholeKit", "PortholeCore", "LifecycleKit"],
        ),
        unitTests(
            name: "PortholeSwiftDataTests",
            bundleIdSuffix: "porthole.swiftdata",
            productDependency: "PortholeSwiftData",
            sources: ["Shared/Porthole/PortholeSwiftData/Tests/**"],
        ...
        unitTests(
            name: "WherePortholeTests",
            bundleIdSuffix: "where.porthole",
            productDependency: "WherePorthole",
            sources: ["Where/WherePorthole/Tests/**"],
            extraPackageProducts: ["PortholeKit", "PortholeCore", "WhereCore", "RegionKit"],
        ),
        unitTests(
    ...
    schemes: [
        ...
        testScheme(name: "PortholeKitUITests"),
        ...
        testScheme(name: "WherePortholeTests"),
