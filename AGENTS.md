...
| Mac (native, Ledger)         | macOS 26.0  |

## Directory layout

Every module — shared ones under `Shared/`, feature ones under a top-level
folder per feature (e.g. `Where/`, `Ledger/`) — follows this skeleton, and a
new module must too:
