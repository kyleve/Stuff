...
dependencies (WhereCore, Broadway, LifecycleKit, Periscope, SnapshotKit,
...
every type-keyed lookup (SwiftUI `EnvironmentKey`s, `UITraitBridgedEnvironmentKey`
bridging such as SnapshotKit's `\.isCapturingSnapshot`, Broadway's
