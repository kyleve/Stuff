...
# `WhereUISnapshotTests` scheme for the image-snapshot suite — reading
...
WhereUISnapshotTests scheme — then prints the hot spots.
...
if [ "$DO_TESTS" = true ]; then
    ...
    SECONDS=0
    set +e
    # The autogenerated workspace scheme lists WhereUISnapshotTests in its
