...
- **Measured 2026-07-28 with `SNAPSHOT_TIMING=1` over 260 references of the time.** The suite holds 472 as of 2026-08-23. Re-measure before acting on the split below.
...
- **Run in `both` mode (2026-07-28) over 260 references of the time — 472 as of 2026-08-23.** The counts below are that run's, not current.
