...
- **Flyover may import SwiftUI, BroadwayCore/BroadwayUI, and SnapshotKit.** It must not import WhereCore, WhereUI, persistence frameworks, or any app module.
...
- **Open the canvas fitted to its width.** Reserve whole-graph framing for the explicit Fit All action.
