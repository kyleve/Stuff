...
public struct InspectorEntity: Identifiable, Sendable {
    ...
    public let type: any PersistentModel.Type
    ...
    /// display them.
    public let binaryColumns: Set<String>
    ...
    public let relationshipColumns: Set<String>
