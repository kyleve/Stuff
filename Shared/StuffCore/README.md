...
Scaffold SPM library for code shared across Stuff apps. Today it only exposes a
placeholder `StuffCore.version` constant so the module, test bundle, and docs
