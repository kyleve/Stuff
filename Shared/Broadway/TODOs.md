...
- perf(BroadwayCore) [needs-design]: Evict the stylesheet cache under memory pressure (`BStylesheets.swift:91`, documented in a source `TODO`); it currently only grows. (audit 2026-07-26; re-verified 2026-08-30)
...
- docs(BroadwayCatalog) [quick-win]: `README.md:3-4` promises a "living catalog" of components that the placeholder `ContentView` (`ContentView.swift:6-17`, an icon and a title) doesn't provide. Build the gallery or narrow the README to what ships. (audit 2026-07-26; re-verified 2026-08-30)
