...
/// The shared backup sections and controls, independent of screen activation.
/// The parent owns observation and secret-hiding lifecycle; snapshots pin these sections.
struct BackupSettingsContent: View {
    ...
    #Preview {
        Form {
            BackupSettingsContent(backup: PreviewSupport.backupModel(), recordingEnabled: true)
        }
        .whereBroadwayRoot()
    }
#endif
