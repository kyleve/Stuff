...
/// it was left. Persistence is deliberately kept *local to this developer
/// surface* rather than routed through `WherePreferences` — dev
...
final class DeveloperOverlayModel {
    ...
    /// Device-local defaults keys for the developer window's persisted geometry.
