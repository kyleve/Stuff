        ...
        Section {
            if let attachment = model.attachment {
                ...
                Button(role: .destructive) {
                    ...
                    Label(.evidenceFormRemove, systemImage: "trash")
                }
            } else {
                Button {
                    showingFileImporter = true
                } label: {
                    Label(.evidenceFormChooseFile, systemImage: "doc")
                }
                PhotosPicker(selection: $photoItem, matching: .images) {
                    Label(.evidenceFormChoosePhoto, systemImage: "photo")
                }
            }
        } header: {
            Text(.evidenceFormAttachmentHeader)
        }
    }
