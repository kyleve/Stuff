...
public struct RootView: View {
    ...
    extension RootView: SnapshotProviding {
        /// Capture the logged-in destination directly: `LifecycleContainer` is
        /// greedy launch chrome, while `MainTabs` owns the scroll-backed content
        /// this case pins. The settle floor still outlasts tab-bar material
        /// adaptation and `MainTabs`' initial report activation.
