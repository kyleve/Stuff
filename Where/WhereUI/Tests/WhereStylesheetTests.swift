...
struct WhereStylesheetTests {
    ...
    @Test func calendarStyle() {
        ...
        #expect(month.currentMonthHighlight == Color.accentColor.opacity(0.14))
        #expect(month.currentBorder == Color.accentColor)
        #expect(month.currentBorderWidth == 4)
        #expect(month.currentGlow == Color.accentColor.opacity(0.4))
        #expect(month.currentGlowRadius == 10)
        #expect(month.futureOpacity == 0.55)
        #expect(month.teaserPeekHeight == 150)
