...
- Seed that root with `WhereWidgetEntry.theme` from `WidgetPresentationStore`
  and the snapshot's region appearances; theme publication remains independent
  from data snapshot publication.
