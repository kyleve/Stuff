...
| `Resources/AppIcon.xcassets` | The primary and alternate app icons. Kept in sync transactionally by `./icons`. Use `--dry-run` to validate. Do not edit by hand. |
...
Its `--dry-run` plans the operation without signing or touching a device.
